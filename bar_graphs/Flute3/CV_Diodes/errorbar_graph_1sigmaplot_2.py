...
#            sign=1
        ...
        #xspace = np.linspace((bin_left - (sign * bin_left / 2)), (bin_right + (sign * bin_right / 2)), 10000)
        xspace = np.linspace(0, 600, 10000)
        ...
        ax3.set_xlim(left=0, right=600)
        ax3.set_ylim(bottom=0.0)
        ax3.set_ylabel("Number of batches", fontsize=15)
        ax3.set_xlabel("Average value of depletion voltage [V]", fontsize=15)
...
#        print("numb", 2*round_up(max(data['Average']), 0))
        ...
        ax2.set_ylabel("Depletion Voltage [V]", fontsize=25)
        #####################################################################
        #### tick labels #############################################################
