...
for file_name in file_names:
    ...
    if pos != -1:
        ...
        ax3.set_xlabel("Average value of bulk resistivity voltage [k$\Omega$cm]", fontsize=15)
        ...
        ax2.set_ylabel("Bulk resistivityVoltage [k$\Omega$cm]", fontsize=25)
        #####################################################################
        #### tick labels #############################################################
