...
for file_name in file_names:
    ...
    if pos != -1:
        ...
        (mu, sigma) = norm.fit(values_of_2S_and_PSs)
        #####################################################################
        ...
        popt, pcov = curve_fit(fit_function, xdata=binscenters, ydata=data_entries_1, p0=[0.0, 0.0, 2, sigma])
        print(popt)
        n, bins, patches = ax3.hist(values_of_2S_and_PSs, color='blue', alpha=0.5, bins=bins_1, label="Histogram")
