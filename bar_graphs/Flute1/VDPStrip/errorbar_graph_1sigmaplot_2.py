...
fig.suptitle('n+ implant VDP measurement', fontsize=20)
...
for file_name in file_names:
    ...
    if pos != -1:
        ...
        ax3.set_xlim(left=30, right=40)
        ax3.set_ylim(bottom=0.0)
        ax3.set_ylabel("Number of batches", fontsize=15)
        #ax3.set_xlabel("Average value of flat band voltage [V]", fontsize=15)
        ax3.set_xlabel("Average value of sheet resistance [$\Omega$/sq]", fontsize=15)
        ...
        #ax2.set_ylabel("Flat band Voltage [V]", fontsize=25)
