...
for file_name in file_names:
    ...
    if pos != -1:
        ...
        left, bottom, width, height = [0.15, 0.70, 0.25, 0.25]
        ...
        values_of_2S_and_PSs = Flute1_results['Nox']
        ...
        bins1 = np.linspace(0.0, 25.0*1E+10, 100)
        ...
        xspace = np.linspace(0.0, 25.0*1E+10, 10000)
        ...
        bins2 = np.linspace(0, 25.0*1E+10, 100)
        ...
        ax3.set_xlim(left=0, right=20*1E+10)
        ax3.set_ylim(bottom=0.0)
        ax3.set_ylabel("Number of wafers", fontsize=15)
        ax3.set_xlabel("Nox [cm^2]", fontsize=15)
        ...
        ax2.set_ylim(bottom=0, top=25*1E+10)
        ...
        ax2.set_ylabel("Nox [$cm^{-2}$]", fontsize=25)
        #####################################################################
        #### tick labels #############################################################
