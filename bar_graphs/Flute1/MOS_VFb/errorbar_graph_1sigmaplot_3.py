...
for file_name in file_names:
    ...
    if pos != -1:
        ...
        left, bottom, width, height = [0.15, 0.25, 0.25, 0.25]
        ...
        xspace = np.linspace(-6.0, 0.0, 10000)
        ...
        print(xmin)
        print(x_max)
        ax2.set_title("MOS measurements")
        ...
        ax2.set_ylabel("Flatband Voltage [V]", fontsize=25)
        #####################################################################
        #### tick labels #############################################################
