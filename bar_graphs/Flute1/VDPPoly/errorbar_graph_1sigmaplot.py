...
fig.suptitle('Polysilicon VDP measurments', fontsize=20)
##Filechooser
root = tk.Tk()
...
for file_name in file_names:
    ...
    if pos != -1:
        ...
        ax2.set_ylim(0.0, 2.5+round_up(ymax, n))
        ...
        n, bins, patches = ax3.hist(data['Average'], range=(-(1+round_up(ymax, n)), 1+round_up(ymax, n)), color='orange', bins=100, label="Histogram")
