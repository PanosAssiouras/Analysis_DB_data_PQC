...
fig.suptitle('Line width of p-stop implant', fontsize=20)
##Filechooser
root = tk.Tk()
...
for file_name in file_names:
    ...
    if pos != -1:
        ...
        ax2.set_ylim(0.0, 50+round_up(ymax, n))
        ...
        n, bins, patches = ax3.hist(data['Average'], range=(-(50+round_up(ymax, n)), 50+round_up(ymax, n)), color='orange', bins=150, label="Histogram")
