...
left, bottom, width, height = [0.70, 0.18, 0.25, 0.25]
...
ax3.yaxis.set_minor_locator(MultipleLocator(200))
ax3.yaxis.set_major_locator(MultipleLocator(400))
