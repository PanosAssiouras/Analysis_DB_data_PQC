...
parameter = "T_UM"
measurement = "Linewidth p-stop"
axis_label = "Linewidth [$\mu$m]"
lower_limit = 25
upper_limit = 100
...
ax2.yaxis.set_minor_locator(MultipleLocator(5.0))
...
ax3.xaxis.set_minor_locator(MultipleLocator(5.0))
ax3.xaxis.set_major_locator(MultipleLocator(10.0))
