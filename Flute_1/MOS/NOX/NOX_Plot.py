...
for file_name in file_names:
    ...
    if pos != -1:
        ...
        Flute1_results = pd.read_csv(file_name, sep=",", skiprows=0)
        Flute1_results_PSP = pd.read_csv(file_name, sep=",", skiprows=0)
        ...
        #####################################################################
        #### tick labels #############################################################
        xtick_labels = [ name for name in Flute_average['Name']]
        ax2.set_xticks(np.arange(len(xtick_labels)))
        # set parameters for tick labels ##############################################
        ax2.yaxis.set_minor_locator(MultipleLocator(0.5E+11))
        ax2.yaxis.set_major_locator(MultipleLocator(1.0E+11))
        ...
        for index in data.index:
            print(data['batch_number'][index])
            print(type(data['batch_number'][index]))
            #if (data['batch_number'][index])
            if data['Type'][index] == "2-S":
                names_of_2S = [str(data['batch_number'][index])]
                values_of_2S = [abs((data[parameter][index]))]
               ...
               # values_of_2S_and_PSs.append((data['Average'][index]))
                ...
                ax2.scatter(names_of_2S, values_of_2S, color='Blue', alpha=1, marker='o', label="2S batches")
            elif data['Type'][index] == "PSS":
                names_of_PSs=[str(data['batch_number'][index])]
                values_of_PSs=[abs(data[parameter][index])]
               ...
               # values_of_2S_and_PSs.append((data['Average'][index]))
                ...
                ax2.scatter(names_of_PSs, values_of_PSs, color='Green', alpha=1, marker='v', label="PSs batches")
            elif data['Type'][index] == "PSP":
                print("Is PSP")
                names_of_PSp = [str(data['batch_number'][index])]
                values_of_PSp = [abs(data[parameter][index])]
               ...
               # values_of_PSp_batches.append((data['Average'][index]))
                ...
                ax2.scatter(names_of_PSp, values_of_PSp, color='red', alpha=1, marker='s', label="PSp batches")
        #############################################################################################################
        ...
        ax3.set_xlabel(label_axis, fontsize=18)
        # set parameters for tick labels ##############################################
        ...
        ax3.xaxis.set_minor_locator(MultipleLocator(0.5E+11))
        ax3.xaxis.set_major_locator(MultipleLocator(1.0E+11))
        ...
        ax2.set_ylabel(label_axis, fontsize=20)
