...
for file_name in file_names:
    ...
    if pos != -1:
        ...
        Flute1_results = pd.read_csv("./MOS_TOX_NM_all.csv", sep=",", skiprows=0)
        Flute1_results_PSP = pd.read_csv("./MOS_TOX_NM_all.csv", sep=",", skiprows=0)
        ...
        values = Flute1_results[parameter]
        ...
        xspace = np.linspace(500, 900, 10000)
        ...
        '''
        ax3.set_xlim(left=500, right=900)
        ax3.set_ylim(bottom=0.0)
        ax3.set_ylabel("Number of wafers", fontsize=18)
        ax3.set_xlabel("TOX [nm]", fontsize=18)
        ...
        ax2.set_ylim(bottom=500, top=900)
        ...
        ax2.set_ylabel("TOX [nm]", fontsize=20)
        #####################################################################
        #### tick labels #############################################################
