...
axis_label = "Full depletion voltage [V]"
lower_limit = 0.0
upper_limit = 600
...
xtick_labels = xtick_labels[1::2]
ax2.set_xticks(np.arange(len(xtick_labels)))
ax2.yaxis.set_minor_locator(MultipleLocator(50))
ax2.yaxis.set_major_locator(MultipleLocator(100))
ax2.tick_params(axis='x', which='major', labelsize=14, length=15)
ax2.tick_params(axis='x', which='minor', labelsize=14, length=5)
...
for batch_number in xtick_labels:
    values_of_2S_and_PSs = Flute_results[(Flute_results['Type'] == "PSS") | (Flute_results['Type'] == "2S") & (Flute_results['batch_number'] == batch_number)]
