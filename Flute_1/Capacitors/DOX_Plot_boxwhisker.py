...
parameter = "DOX_NM"
measurement = "CAP_E"
axis_label = "Dielectric thikness [nm]"
lower_limit = 100
upper_limit = 600
...
data = pd.read_csv("./" + parameter +"_"+ measurement+ "_all.csv", sep=",", skiprows=0)
Flute_results = pd.read_csv("./" + parameter+"_"+ measurement + "_all.csv", sep=",", skiprows=0)
Flute_results_PSP = pd.read_csv("./" + parameter+"_"+ measurement + "_all.csv", sep=",", skiprows=0)
Flute_average = pd.read_csv("./" + parameter+"_"+ measurement + "_average_values.csv", sep=",", skiprows=0)
...
left, bottom, width, height = [0.35, 0.68, 0.25, 0.25]
