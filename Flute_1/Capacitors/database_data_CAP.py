...
parameters = ["CAC_PFRD", "DOX_NM"]
search_limits = [[1.0, 4.0], [0.0, 500.0]]
measurements = ["CAP_E", "CAP_W"]
flute = "PQC1"
...
for measurement in measurements:
    ...
    for parameter in parameters:
        ...
        data.insert(2, "Orientation", orientations,
                    True)  # orientation West or East inserted to table in separate column
        ...
        data_reduced = data_filtered[
            ['batch_number', 'Type', 'Orientation', 'Location', 'KIND_OF_HM_STRUCT_ID', 'KIND_OF_HM_SET_ID', 'TEMP_SET_DEGC', 'AV_TEMP_DEGC',
             parameter]]
        ...
        data_reduced2.to_csv(parameter +"_"+ measurement + '_average_values.csv', index=False)
        param_number += 1
