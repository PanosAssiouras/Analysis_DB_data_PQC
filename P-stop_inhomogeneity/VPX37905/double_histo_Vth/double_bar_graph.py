...
#        print(east_left_values)
#        print(west_left_values)
        for tick in ind:
        ...
        ax2.set_title("Threshold voltage (VPX37905)", fontsize=35)
        plt.legend(handles, labels, prop={'size': 24})
        ...
        ax2.tick_params(axis='both', which='minor', labelsize=20, length=10)
        ...
        ax2.text(3.0, 4.8, 'Left flute set', color='red', ha='center', fontsize=35)
