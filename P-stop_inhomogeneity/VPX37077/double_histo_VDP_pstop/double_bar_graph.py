...
for file_name in file_names:
    ...
    if (pos!=-1):
        ...
        ax2.set_ylim(10.0, 30.0)
        ax2.set_title("Sheet resistance of p-stop (VPX37077)", fontsize=35)
        plt.legend(handles, labels, prop={'size': 30})
        plt.xticks(fontsize=32)
        plt.yticks(fontsize=32)
        plt.xlabel('Wafer serial number', fontsize=38)
        plt.ylabel('Sheet resistance [k\u03A9/sq.]', fontsize=38)
        ...
        ax2.axvline(x=6.7, color='red', linestyle='--', linewidth=2)
        ax2.text(8.0, 22.0, 'Right flute set', color='red', ha='center', fontsize=35)
        ax2.text(3.0, 22.0, 'Left flute set', color='red', ha='center', fontsize=35)
